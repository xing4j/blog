...
examples, see [reference.md](./reference.md). If you need to fill out a PDF form, read [forms.md](./forms.md) and
...
ReportLab PDFs. Use XML markup tags instead:
```python
...
- For advanced pypdfium2 usage and JavaScript libraries (pdf-lib), see [reference.md](./reference.md)
